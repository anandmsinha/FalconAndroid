...
public class MultipleFilesSelectionActivity extends Activity {
  ...
  public void iconload(){
    ...
    CustomListSingleOnly adapter1 = new CustomListSingleOnly(MultipleFilesSelectionActivity.this, directoryNames.toArray(foldernames), mainPath.getPath());
    CustomList adapter2 = new CustomList(MultipleFilesSelectionActivity.this, fileNames.toArray(filenames), mainPath.getPath());
